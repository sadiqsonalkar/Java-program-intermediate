...
{
	Frame f=new Frame("JAY SANDWICH");
	...
	Checkbox c1=new Checkbox("Cheese Sandwich = 100");
	Checkbox c2=new Checkbox("Pizza           = 500");
	Checkbox c3=new Checkbox("Chicken Roll 	  =	300");
	Checkbox c4=new Checkbox("Takeaway 	  =	15");
